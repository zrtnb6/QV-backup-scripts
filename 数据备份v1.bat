...
echo ---
echo 注意
echo 此脚本最后修改于2024.10.7
echo 在运行本脚本前，请确保需要备份的软件已经关闭
echo 如果曾经使用过本脚本，将优先将曾经备份过的文件删除
echo ---
...
for %%i in (%choices%) do (
    if "%%i"=="1" (
        ...
        if exist QQ备份 (
            echo 检测到旧备份存在，为你先删除旧备份目录
            rmdir /s /q QQ备份
        )
        
        7z a -v4g -mx1 QQ备份\!zipname! "!QQdata!"
        echo QQ备份完成
        ...
        7z a -v4g -mx1 微信备份\!zipname! "!WeChatdata!"
        echo 微信备份完成
        ...
        7z a -v4g -mx1 企业微信备份\!zipname! "!QYWXdata!"
        echo 企业微信备份完成
